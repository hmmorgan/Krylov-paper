...
\affil[2]{Geophysical Fluid Dynamics group,  ETH Z{\"u}rich,  Z{\"u}rich, Switzerland}
...
\begin{figure}
\centering
\includegraphics[width=6cm]{../plots/GMRES_ex23_8192_1000000_independent_in_p_2500.pdf}
\includegraphics[width=6cm]{../plots/PGMRES_ex23_8192_1000000_independent_in_p_2500.pdf}
\caption{Time for iteration  $k=2500$ on process $p$. } \label{fig:ex23-independent}
\end{figure}


Figure \ref{fig:ex23-independent} shows the time for iteration $k=2500$ on process $p$ for the first 1000 processors in order of MPI rank. Iterates are drawn with grey bars.
GMRES iterates are nearly constant on a node, so that each KNL node of 64 processors is clearly visible in Figure \ref{fig:ex23-independent} (left) so that the iterations are not really independent in $p$ as we claimed above. The variance of iteration times on node 0 (with MPI ranks 0-63) is $6.3\cdot10^{-13}$. 
...
\begin{figure}[b]
\centering
\includegraphics[width=6cm]{../plots/GMRES_ex23_8192_1000000_stationary_in_t_colormap6.png}
...
\includegraphics[width=4cm]{../plots/GMRES_ex48_8192_1000000_independent_in_p_2500.pdf}
\includegraphics[width=4cm]{../plots/GMRES_ex48_8192_1000000_stationary_in_t_colormap2.png} \\
\includegraphics[width=4cm]{../plots/PGMRES_ex48_8192_1000000_identical_in_p.png}
\includegraphics[width=4cm]{../plots/PGMRES_ex48_8192_1000000_independent_in_p_2500.pdf} 
\includegraphics[width=4cm]{../plots/PGMRES_ex48_8192_1000000_stationary_in_t_colormap2.png}
